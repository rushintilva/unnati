...
<body>
	...
	<div class="top-header">
		<div class="container">
			...
			<a href="login.html" style="float: right;padding-top: 12px;"><span class="glyphicon glyphicon-log-in">&nbsp;</span>LOG IN</a>
		</div>
	</div>
	...
	<div class="signup-section">
		<div class="row">
			<div class="col-md-6">		
				...
				<a href="signupecomp.html"><button class="signup-button"><span>SIGNUP</span></button></a>
			</div>
			...
			<div class="col-md-6">
				...
				<a href="signupiti.html"><button class="signup-button"><span>SIGNUP</span></button></a>
			</div>
		</div>
	</div>	
